...
public class SkeletonSampleSpringBootApplication implements CommandLineRunner {

	private static Logger LOGGER = LoggerFactory.getLogger(SkeletonSampleSpringBootApplication.class);
	...
	public static void main(String[] args) throws IOException {
		try {
			SpringApplication.run(SkeletonSampleSpringBootApplication.class, args);
		}
		catch (Exception e) {
