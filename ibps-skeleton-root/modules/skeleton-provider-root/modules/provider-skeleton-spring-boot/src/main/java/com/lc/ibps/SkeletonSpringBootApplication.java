...
public class SkeletonSpringBootApplication implements CommandLineRunner {

	private static Logger LOGGER = LoggerFactory.getLogger(SkeletonSpringBootApplication.class);
	...
	public static void main(String[] args) throws IOException {
		try {
			IbpsApplication.run(SkeletonSpringBootApplication.class, args);
		}
		catch (Exception e) {
